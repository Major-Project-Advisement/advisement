<?php 
    ...
    $main = '<div class="container col-md-12">         
                ...
                <div class="card ">
                <div class="card-header main-color-bg">Change Password</div>
                <div class="card-body">
                    <form id="login_form" action="studentEditPasswordValid.php" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" name="oldpword" placeholder="Old password"required="" autofocus="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" name="newpword" placeholder="New password"required="" autofocus="">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">Conirm password</label>
                            <div class="col-md-6">
