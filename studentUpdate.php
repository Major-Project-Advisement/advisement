    ...
    $main = '<div class="container col-md-12">         
                ...
                <div class="">
                    ...
                    <div class="divTable mb-3" style="border: 1px solid #000;" >
                        <div class="divTableBody" data="'.$UID.'">
                        
                            <div class="divTableRow row">
                                <div class="divTableCell"><b>First Name: </b><br>'.$FirstName.'</div>
                                <div class="divTableCell"><a href="studentEdit.php?name=First%20Name&edit=FirstName&current='.$FirstName.'" class="btn btn-info"> Edit </a></div>
                            </div>
                            <div class="divTableRow row">
                                <div class="divTableCell"><b>Last Name: </b><br>'.$LastName.'</div>
                                <div class="divTableCell"><a href="studentEdit.php?name=Last%20Name&edit=LastName&current='.$LastName.'" class="btn btn-info"> Edit </a></div>
                            </div>
                            <div class="divTableRow row">
                                <div class="divTableCell"><b>Phone Number: </b><br>'.$Phone.'</div>
                                <div class="divTableCell"><a href="studentEdit.php?name=Number&edit=Phone&current='.$Phone.'" class="btn btn-info"> Edit </a></div>
                            </div>
                            <div class="divTableRow row">
                                <div class="divTableCell"><b>Email Address: </b><br>'.$Email.'</div>
                                <div class="divTableCell"><a href="studentEdit.php?name=Email%20Address&edit=Email&current='.$Email.'" class="btn btn-info"> Edit </a></div>
                            </div>
                            <div class="divTableRow row">
                                <div class="divTableCell"><b>Password: </b><br>*********</div>
                                <div class="divTableCell"><a href="studentEditPassword.php" class="btn btn-info"> Edit </a></div>
                            </div>
